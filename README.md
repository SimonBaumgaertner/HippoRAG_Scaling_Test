...
## Results & Analysis
The plot below shows the relationship between the number of documents and the total indexing time. The data suggests a quadratic growth pattern, which is significantly slower than the ideal linear projection.
